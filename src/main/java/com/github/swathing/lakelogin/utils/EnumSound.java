package com.github.swathing.lakelogin.utils;
...
public enum EnumSound {
  ...
  public void play(@NotNull Player player, Location location, float f1, float f2) {
    player.playSound(location, this.getSound(), f1, f2);
  }

  public void play(@NotNull World world, Location location, float f1, float f2) {
